...
import com.renren.android.*;

public class RenrenUtil implements Parcelable{
	 ...
	 * @param appId
	 */
	public RenrenUtil(String apiKey, String secret, String appId, Context context) {
		if (apiKey == null) {
	 ...
	 *             出现其他错误。
	 */
	public void updateAccessToken(String accessToken) throws RenrenError,
			RuntimeException {
...
//	}
	 ...
	 * 发布新鲜事<br>
	 * 同步调用feed.get接口
	 * 参见http://wiki.dev.renren.com/wiki/Feed.get
	 * 
	 * @param feed
	 * 			要发送的新鲜事
	 * @return 
...
//	}
	...
	public void startRenrenRequestActivity(Activity activity, Intent intent) {
		intent.putExtra(RenrenUtil.RENREN_LABEL, this);
...
//	}
	...
	public static final Parcelable.Creator<RenrenUtil> CREATOR = new Parcelable.Creator<RenrenUtil>() {
		public RenrenUtil createFromParcel(Parcel in) {
			return new RenrenUtil(in);
		}

		public RenrenUtil[] newArray(int size) {
			return new RenrenUtil[size];
		}
	};
