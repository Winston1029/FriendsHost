...
public class AsyncRenren {
	 ...
	 *          若超出了长度，是否自动截短至限制的长度
	 */
	public void getFeed(FeedExtractRequestParam feed,
			AbstractRequestListener<FeedExtractResponseBean> listener,
			boolean truncOption) {
		FeedHelper helper = new FeedHelper(renren);
		helper.asyncGet(pool, feed, listener, truncOption);
	}
