...
/**
 * @author �?�勇(yong.li@opi-corp.com) 2011-6-9
 */
public class SSO {
    ...
    public SSO(RenrenUtil renren) {
        this.renren = renren;
    }

    /**
     * 使用Single Sign-on功能 完�?登录和授�?�(User-Agent Flow)。
     * 警告：使用此方法获�?�返回值请在调用此方法的activity中 �?写onActivityResult
     * 并在onActivityResult中调用renren.authorizeCallback
     * 
     * @param activity
     * @param permissions 应用想拥有的�?��?列表。
     * @param requestCode 在callback时需�?的requestCode.
     * @param listener
     */
    ...
    /**
     * 注�?：使用�?�点登录功能时请务必在调用activity中 �?写onActivityResult(int requestCode, int
     * resultCode, Intent data)方法 并在该方法中调用authorizeCallback�?�?�以获得返回值。
     */
